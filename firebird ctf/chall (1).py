...
class Quintessential_Quintuples:
    ...
    # I have no idea why MODE 4 doesn't exist, maybe it's because Yotsuba is the final winner in the comic i guess...
    modes = (1, 2, 3, 5, 6)

    def __init__(self):
        self.keys = dict(
            zip(self.modes, [hashlib.md5(os.urandom(3)).digest() for _ in self.modes]))
